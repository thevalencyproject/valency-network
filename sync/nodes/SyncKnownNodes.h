...
public:
    ...
    void sync(std::vector<Position4D>* knownNodes, std::vector<NodeInfo> nodes);         // Onion-Routing - ensure nodes vector only contains onion-routing nodes and not destination server
    void nodeSync(std::vector<Position4D>* knownNodes);                                  // Non Onion-Routing
    void nodeSync(std::vector<Position4D>* knownNodes, std::vector<NodeInfo> nodes);     // Onion-Routing - ensure nodes vector only contains onion-routing nodes and not destination server
